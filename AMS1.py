...
window = tk.Tk()
window.title("AMS- Attendance Management System Using Facial Recognition")
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='D:/Expt/Mini Project-1/Attendance-Management-System-master/Attendance-Management-System-master/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"D:\Expt\Mini Project-1\Attendance-Management-System-master\Attendance-Management-System-master\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'D:/Expt/Mini Project-1/Attendance-Management-System-master/Attendance-Management-System-master' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"D:\Expt\Mini Project-1\Attendance-Management-System-master\Attendance-Management-System-master\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == '' :
            if password == '':
                ...
                cs = 'D:/Expt/Mini Project-1/Attendance-Management-System-master/Attendance-Management-System-master/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
